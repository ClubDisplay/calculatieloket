...
export const calculators: CalculatorDefinition[] = [
  ...
  {
    id: "btw-21-procent",
    slug: "btw-21-procent-berekenen",
    url: "/btw-21-procent-berekenen/",
    title: "BTW 21 procent berekenen",
    shortTitle: "21% BTW",
    description: "Bereken eenvoudig 21% btw over elk bedrag. Zie direct bedrag exclusief, btw-bedrag en inclusief. Gebaseerd op het hoge btw-tarief van de Belastingdienst.",
    shortDescription: "Bereken snel 21% btw over een bedrag.",
    category: "Belasting",
    iconKey: "percent",
    keywords: ["btw", "21", "21 procent", "btw berekenen", "exclusief", "inclusief", "hoog tarief"],
    intents: ["btw 21 procent berekenen", "21 procent btw", "hoog btw tarief"],
    related: ["btw", "btw-terugrekenen", "btw-inclusief-exclusief", "btw-9-procent", "exclusief-naar-inclusief"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    seo: {
      title: "BTW 21 procent berekenen — Hoog tarief | Calculatieloket.nl",
      description: "Bereken eenvoudig 21% btw over elk bedrag. Zie direct bedrag exclusief, btw-bedrag en inclusief. Gebaseerd op het hoge btw-tarief van de Belastingdienst.",
    },
    schema: {
      howTo: {
        name: "21% btw berekenen",
        description: "Stappen om 21% btw te berekenen over een bedrag.",
        totalTime: "PT30S",
        steps: [
          { name: "Vul het bedrag in", text: "Voer het bedrag in waarover je 21% btw wilt berekenen." },
          { name: "Bekijk het resultaat", text: "De calculator toont het bedrag exclusief, het btw-bedrag en het bedrag inclusief." },
        ],
      },
    },
  ...
  {
    id: "btw-9-procent",
    slug: "btw-9-procent-berekenen",
    url: "/btw-9-procent-berekenen/",
    title: "BTW 9 procent berekenen",
    shortTitle: "9% BTW",
    description: "Bereken eenvoudig 9% btw over elk bedrag. Zie direct bedrag exclusief, btw-bedrag en inclusief. Gebaseerd op het lage btw-tarief van de Belastingdienst.",
    shortDescription: "Bereken snel 9% btw over een bedrag.",
    category: "Belasting",
    iconKey: "percent",
    keywords: ["btw", "9", "9 procent", "btw berekenen", "exclusief", "inclusief", "laag tarief"],
    intents: ["btw 9 procent berekenen", "9 procent btw", "laag btw tarief"],
    related: ["btw", "btw-terugrekenen", "btw-inclusief-exclusief", "btw-21-procent", "exclusief-naar-inclusief"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "BTW 9 procent berekenen — Laag tarief | Calculatieloket.nl",
      description: "Bereken eenvoudig 9% btw over elk bedrag. Zie direct bedrag exclusief, btw-bedrag en inclusief. Gebaseerd op het lage btw-tarief van de Belastingdienst.",
    },
    schema: {
      howTo: {
        name: "9% btw berekenen",
        description: "Stappen om 9% btw te berekenen over een bedrag.",
        totalTime: "PT30S",
        steps: [
          { name: "Vul het bedrag in", text: "Voer het bedrag in waarover je 9% btw wilt berekenen." },
          { name: "Bekijk het resultaat", text: "De calculator toont het bedrag exclusief, het btw-bedrag en het bedrag inclusief." },
        ],
      },
    },
  ...
  {
    id: "btw-van-bedrag-afhalen",
    slug: "btw-van-bedrag-afhalen",
    url: "/btw-van-bedrag-afhalen/",
    title: "BTW van bedrag afhalen",
    shortTitle: "BTW afhalen",
    description: "Haal btw van een totaalbedrag af. Reken inclusief btw om naar exclusief btw en zie direct het btw-bedrag. Gebaseerd op de officiële tarieven.",
    shortDescription: "BTW van een totaalbedrag afhalen.",
    category: "Belasting",
    iconKey: "percent",
    keywords: ["btw", "afhalen", "van bedrag afhalen", "inclusief", "exclusief", "terugrekenen"],
    intents: ["btw van bedrag afhalen", "btw eraf halen", "btw uithalen"],
    related: ["btw-terugrekenen", "btw", "btw-inclusief-exclusief", "btw-21-procent", "btw-9-procent"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "BTW van bedrag afhalen — Inclusief naar exclusief | Calculatieloket.nl",
      description: "Haal btw van een totaalbedrag af. Reken inclusief btw om naar exclusief btw en zie direct het btw-bedrag. Gebaseerd op de officiële tarieven.",
    },
    schema: {
      howTo: {
        name: "BTW van een bedrag afhalen",
        description: "Stappen om btw van een inclusief bedrag af te halen.",
        totalTime: "PT30S",
        steps: [
          { name: "Vul het totaalbedrag in", text: "Voer het bedrag inclusief btw in." },
          { name: "Kies het btw-tarief", text: "Selecteer 21%, 9% of 0% btw." },
          { name: "Bekijk het exclusieve bedrag", text: "De calculator toont het bedrag exclusief btw en het btw-bedrag." },
        ],
      },
  ...
  },
  {
    ...
    slug: "hoe-bereken-je-btw",
    url: "/hoe-bereken-je-btw/",
    title: "Hoe bereken je btw?",
    shortTitle: "Btw berekenen",
    description: "Leer hoe je btw berekent inclusief en exclusief. Met voorbeelden, formules en een gratis rekenmachine. Gebaseerd op de Belastingdienst.",
    shortDescription: "Leer hoe je btw berekent met voorbeelden en formules.",
    category: "Belasting",
    iconKey: "calc",
    keywords: ["btw", "berekenen", "hoe", "formule", "uitleg", "inclusief", "exclusief"],
    intents: ["hoe bereken je btw", "hoe btw berekenen", "hoe reken je btw"],
    related: ["btw", "btw-21-procent", "btw-9-procent", "btw-terugrekenen", "btw-inclusief-exclusief"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Hoe bereken je btw? — Formule en voorbeelden | Calculatieloket.nl",
      description: "Leer hoe je btw berekent inclusief en exclusief. Met voorbeelden, formules en een gratis rekenmachine. Gebaseerd op de Belastingdienst.",
    },
    schema: {
      howTo: {
        name: "BTW berekenen",
        description: "Stappen om btw te berekenen inclusief en exclusief.",
        totalTime: "PT1M",
        steps: [
          { name: "Bepaal het bedrag", text: "Voer het bedrag in waarover je btw wilt berekenen." },
          { name: "Kies het tarief", text: "Selecteer 21%, 9% of 0% btw." },
          { name: "Kies de richting", text: "Bereken exclusief naar inclusief, of inclusief naar exclusief." },
          { name: "Bekijk het resultaat", text: "De calculator toont het exclusieve bedrag, het btw-bedrag en het inclusieve bedrag." },
        ],
      },
    },
    officialSources: [
  ...
  {
    id: "btw-bedrag",
    slug: "btw-bedrag-berekenen",
    url: "/btw-bedrag-berekenen/",
    title: "BTW-bedrag berekenen",
    shortTitle: "BTW-bedrag",
    description: "Bereken het btw-bedrag over een exclusief bedrag. Kies 21%, 9% of 0% en zie direct hoeveel btw je moet berekenen. Gebaseerd op de Belastingdienst.",
    shortDescription: "Bereken het btw-bedrag over een exclusief bedrag.",
    category: "Belasting",
    iconKey: "percent",
    keywords: ["btw", "bedrag", "btw bedrag", "berekenen", "21", "9", "exclusief"],
    intents: ["btw bedrag berekenen", "hoeveel is de btw", "btw bedrag"],
    related: ["btw", "btw-21-procent", "btw-9-procent", "btw-terugrekenen", "exclusief-naar-inclusief"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "BTW-bedrag berekenen — 21%, 9% en 0% | Calculatieloket.nl",
      description: "Bereken het btw-bedrag over een exclusief bedrag. Kies 21%, 9% of 0% en zie direct hoeveel btw je moet berekenen. Gebaseerd op de Belastingdienst.",
    },
    schema: {
      howTo: {
        name: "BTW-bedrag berekenen",
        description: "Stappen om het btw-bedrag over een exclusief bedrag te berekenen.",
        totalTime: "PT30S",
        steps: [
          { name: "Vul het exclusieve bedrag in", text: "Voer het bedrag exclusief btw in." },
          { name: "Kies het btw-tarief", text: "Selecteer 21%, 9% of 0% btw." },
          { name: "Bekijk het btw-bedrag", text: "De calculator toont het btw-bedrag en het totaal inclusief btw." },
        ],
      },
    },
    officialSources: [
  ...
  {
    id: "exclusief-naar-inclusief",
    slug: "exclusief-naar-inclusief-btw",
    url: "/exclusief-naar-inclusief-btw/",
    title: "Exclusief naar inclusief btw",
    shortTitle: "Excl. → Incl. btw",
    description: "Reken eenvoudig exclusief btw om naar inclusief btw. Kies 21%, 9% of 0% en zie direct het totaalbedrag. Gebaseerd op de Belastingdienst.",
    shortDescription: "Reken exclusief btw om naar inclusief btw.",
    category: "Belasting",
    iconKey: "switch",
    keywords: ["btw", "exclusief", "inclusief", "excl naar incl", "exclusief naar inclusief", "omrekenen"],
    intents: ["exclusief naar inclusief btw", "excl naar incl btw", "btw erbij rekenen"],
    related: ["btw", "btw-21-procent", "btw-9-procent", "btw-bedrag", "btw-terugrekenen"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Exclusief naar inclusief btw — 21%, 9% en 0% | Calculatieloket.nl",
      description: "Reken eenvoudig exclusief btw om naar inclusief btw. Kies 21%, 9% of 0% en zie direct het totaalbedrag. Gebaseerd op de Belastingdienst.",
    },
    schema: {
      howTo: {
        name: "Exclusief naar inclusief btw berekenen",
        description: "Stappen om een exclusief bedrag om te rekenen naar inclusief btw.",
        totalTime: "PT30S",
        steps: [
          { name: "Vul het exclusieve bedrag in", text: "Voer het bedrag exclusief btw in." },
          { name: "Kies het btw-tarief", text: "Selecteer 21%, 9% of 0% btw." },
          { name: "Bekijk het inclusieve bedrag", text: "De calculator toont het btw-bedrag en het totaal inclusief btw." },
        ],
      },
    },
    officialSources: [
  ...
  },
  {
    ...
    slug: "nettoloon-2026",
    url: "/nettoloon-2026/",
    title: "Nettoloon 2026",
    shortTitle: "Nettoloon 2026",
    description: "Bereken je nettoloon in 2026. Zie direct hoeveel je netto per maand en per jaar overhoudt. Gebaseerd op Belastingdienst tarieven.",
    shortDescription: "Bereken je nettoloon in 2026.",
    category: "Inkomen",
    iconKey: "euro",
    keywords: ["nettoloon", "netto salaris", "nettoloon 2026", "bruto netto", "loon"],
    intents: ["nettoloon berekenen", "netto salaris", "hoeveel netto"],
    related: ["bruto-netto", "salaris", "vakantiegeld", "hypotheek"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Nettoloon 2026 | Netto salaris berekenen | Calculatieloket.nl",
      description: "Bereken je nettoloon in 2026. Zie direct hoeveel je netto per maand en per jaar overhoudt. Gebaseerd op Belastingdienst tarieven.",
    },
    schema: {
      howTo: {
        name: "Nettoloon berekenen in 2026",
        description: "Stappen om je nettoloon in 2026 te berekenen.",
        totalTime: "PT1M",
        steps: [
          { name: "Vul je bruto maandsalaris in", text: "Voer je bruto maandsalaris in, inclusief vakantiegeld." },
          { name: "Vul je pensioenpremie in", text: "Voer het werknemersdeel van je pensioenpremie per maand in." },
          { name: "Pas loonheffingskorting toe", text: "Zet de loonheffingskorting aan als je deze bij je werkgever hebt." },
          { name: "Bekijk je nettoloon", text: "De calculator toont je nettoloon per maand en per jaar." },
        ],
      },
    },
    officialSources: [
  ...
  {
    id: "salaris-2026",
    slug: "salaris-2026-berekenen",
    url: "/salaris-2026-berekenen/",
    title: "Salaris 2026 berekenen",
    shortTitle: "Salaris 2026",
    description: "Bereken je salaris in 2026. Zie direct je bruto-netto loon per maand en jaar. Gebaseerd op de Belastingdienst tarieven.",
    shortDescription: "Bereken je salaris voor 2026.",
    category: "Inkomen",
    iconKey: "money",
    keywords: ["salaris 2026", "salaris berekenen", "bruto netto salaris", "loon 2026"],
    intents: ["salaris berekenen", "salaris 2026", "bruto netto salaris"],
    related: ["bruto-netto", "nettoloon", "vakantiegeld", "hypotheek"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Salaris 2026 berekenen | Bruto netto salaris | Calculatieloket.nl",
      description: "Bereken je salaris in 2026. Zie direct je bruto-netto loon per maand en jaar. Gebaseerd op de Belastingdienst tarieven.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — Box 1 tarieven 2026",
        description: "Actuele tarieven voor de inkomstenbelasting.",
        href: "https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/prive/inkomstenbelasting/heffingskortingen_boxen_tarieven/boxen_en_tarieven/box_1/box_1",
      },
    ],
  },
  {
    id: "bruto-netto-berekenen",
    slug: "bruto-netto-berekenen-2026",
    url: "/bruto-netto-berekenen-2026/",
    title: "Bruto netto berekenen 2026",
    shortTitle: "Bruto netto 2026",
    description: "Reken bruto om naar netto in 2026. Bereken je salaris per maand of jaar met de Belastingdienst tarieven.",
    shortDescription: "Reken bruto om naar netto in 2026.",
    category: "Inkomen",
    iconKey: "euro",
    keywords: ["bruto netto berekenen", "bruto naar netto", "salaris berekenen 2026", "loon"],
    intents: ["bruto netto berekenen", "bruto naar netto", "salaris omrekenen"],
    related: ["bruto-netto", "nettoloon", "salaris", "vakantiegeld"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Bruto netto berekenen 2026 | Salaris omrekenen | Calculatieloket.nl",
      description: "Reken bruto om naar netto in 2026. Bereken je salaris per maand of jaar met de Belastingdienst tarieven.",
    },
    officialSources: [
      {
  ...
  {
    id: "loonheffing",
    slug: "loonheffing-berekenen-2026",
    url: "/loonheffing-berekenen-2026/",
    title: "Loonheffing berekenen 2026",
    shortTitle: "Loonheffing 2026",
    description: "Bereken de loonheffing in 2026. Zie hoeveel belasting je ongeveer betaalt over je salaris.",
    shortDescription: "Bereken de loonheffing over je salaris in 2026.",
    category: "Inkomen",
    iconKey: "percent",
    keywords: ["loonheffing", "loonbelasting", "belasting salaris", "loonheffing 2026"],
    intents: ["loonheffing berekenen", "hoeveel belasting", "loonheffingskorting"],
    related: ["bruto-netto", "nettoloon", "salaris", "toeslagen"],
    difficulty: "intermediate",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Loonheffing berekenen 2026 | Loonbelasting indicatie | Calculatieloket.nl",
      description: "Bereken de loonheffing in 2026. Zie hoeveel belasting je ongeveer betaalt over je salaris. Gebaseerd op Belastingdienst tarieven.",
    },
    officialSources: [
      {
        label: "Officiële bron",
  ...
  {
    id: "zzp-uurtarief",
    slug: "zzp-uurtarief-berekenen",
    url: "/zzp-uurtarief-berekenen/",
    title: "ZZP uurtarief berekenen",
    shortTitle: "ZZP uurtarief",
    description: "Bereken je ZZP uurtarief voor 2026. Zie welk uurtarief je nodig hebt voor je gewenste netto inkomen.",
    shortDescription: "Bereken je ZZP uurtarief.",
    category: "Ondernemen",
    iconKey: "person",
    keywords: ["zzp uurtarief", "uurtarief berekenen", "zzp tarief", "freelance uurtarief"],
    intents: ["zzp uurtarief berekenen", "hoeveel uurtarief zzp", "freelance tarief"],
    related: ["zzp", "zzp-omzet", "zzp-inkomen", "zzp-kosten"],
    difficulty: "intermediate",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "ZZP uurtarief berekenen 2026 | Uurtarief calculator | Calculatieloket.nl",
      description: "Bereken je ZZP uurtarief voor 2026. Zie welk uurtarief je nodig hebt voor je gewenste netto inkomen. Een indicatie.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — ZZP en inkomstenbelasting",
        description: "Informatie over belasting voor ZZP'ers.",
  ...
  {
    id: "zzp-omzet",
    slug: "zzp-omzet-berekenen",
    url: "/zzp-omzet-berekenen/",
    title: "ZZP omzet berekenen",
    shortTitle: "ZZP omzet",
    description: "Bereken je ZZP omzet voor 2026. Zie hoeveel omzet je nodig hebt voor je gewenste inkomen.",
    shortDescription: "Bereken je benodigde ZZP omzet.",
    category: "Ondernemen",
    iconKey: "person",
    keywords: ["zzp omzet", "omzet berekenen", "zzp omzet 2026", "ondernemers omzet"],
    intents: ["zzp omzet berekenen", "hoeveel omzet zzp", "omzet target"],
    related: ["zzp", "zzp-uurtarief", "zzp-inkomen", "zzp-kosten"],
    difficulty: "intermediate",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "ZZP omzet berekenen 2026 | Omzet en winst | Calculatieloket.nl",
      description: "Bereken je ZZP omzet voor 2026. Zie hoeveel omzet je nodig hebt voor je gewenste inkomen. Een indicatie.",
    },
    officialSources: [
      {
        label: "Officiële bron",
  ...
  {
    id: "zzp-inkomen",
    slug: "zzp-inkomen-berekenen",
    url: "/zzp-inkomen-berekenen/",
    title: "ZZP inkomen berekenen",
    shortTitle: "ZZP inkomen",
    description: "Bereken je netto ZZP inkomen in 2026. Zie hoeveel je overhoudt na kosten en belasting.",
    shortDescription: "Bereken je netto ZZP inkomen.",
    category: "Ondernemen",
    iconKey: "person",
    keywords: ["zzp inkomen", "netto zzp", "zzp inkomen 2026", "ondernemer inkomen"],
    intents: ["zzp inkomen berekenen", "netto zzp inkomen", "hoeveel verdien ik zzp"],
    related: ["zzp", "zzp-uurtarief", "zzp-omzet", "zzp-kosten"],
    difficulty: "intermediate",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "ZZP inkomen berekenen 2026 | Netto ZZP inkomen | Calculatieloket.nl",
      description: "Bereken je netto ZZP inkomen in 2026. Zie hoeveel je overhoudt na kosten en belasting. Een indicatie.",
    },
    officialSources: [
      {
        label: "Officiële bron",
  ...
  {
    id: "zzp-kosten",
    slug: "zzp-kosten-berekenen",
    url: "/zzp-kosten-berekenen/",
    title: "ZZP kosten berekenen",
    shortTitle: "ZZP kosten",
    description: "Bereken je ZZP kosten voor 2026. Zie welke zakelijke kosten je hebt en hoe ze je uurtarief beïnvloeden.",
    shortDescription: "Bereken je ZZP kosten.",
    category: "Ondernemen",
    iconKey: "person",
    keywords: ["zzp kosten", "zakelijke kosten", "zzp kosten 2026", "ondernemer kosten"],
    intents: ["zzp kosten berekenen", "zakelijke kosten zzp", "kosten ondernemer"],
    related: ["zzp", "zzp-uurtarief", "zzp-omzet", "zzp-inkomen"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "ZZP kosten berekenen 2026 | Zakelijke kosten | Calculatieloket.nl",
      description: "Bereken je ZZP kosten voor 2026. Zie welke zakelijke kosten je hebt en hoe ze je uurtarief beïnvloeden. Een indicatie.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — ZZP en aftrekposten",
        description: "Informatie over aftrekbare kosten voor ZZP'ers.",
        href: "https://www.belastingdienst.nl/zzp",
      },
    ],
  },
  {
    ...
    url: "/huurtoeslag-berekenen/",
    title: "Huurtoeslag berekenen",
    shortTitle: "Huurtoeslag",
    description: "Bereken je huurtoeslag in 2026. Zie of je mogelijk recht hebt op huurtoeslag.",
    shortDescription: "Bereken je huurtoeslag.",
    category: "Toeslagen",
    iconKey: "house",
    keywords: ["huurtoeslag", "huurtoeslag berekenen", "huur toeslag", "toeslag huur"],
    intents: ["huurtoeslag berekenen", "mogelijk in aanmerking voor huurtoeslag", "huurtoeslag 2026"],
    related: ["toeslagen", "zorgtoeslag", "kindgebonden-budget", "toeslagen-2026"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Huurtoeslag berekenen 2026 | Indicatie huurtoeslag | Calculatieloket.nl",
      description: "Bereken je huurtoeslag in 2026. Zie of je mogelijk recht hebt op huurtoeslag. Een indicatie op basis van huur en inkomen.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — Huurtoeslag",
        description: "Voorwaarden en bedragen voor huurtoeslag.",
        href: "https://www.belastingdienst.nl/toeslagen/huurtoeslag",
      },
    ],
  },
  {
    ...
    url: "/zorgtoeslag-berekenen/",
    title: "Zorgtoeslag berekenen",
    shortTitle: "Zorgtoeslag",
    description: "Bereken je zorgtoeslag in 2026. Zie of je mogelijk recht hebt op zorgtoeslag.",
    shortDescription: "Bereken je zorgtoeslag.",
    category: "Toeslagen",
    iconKey: "heart",
    keywords: ["zorgtoeslag", "zorgtoeslag berekenen", "zorg toeslag", "toeslag zorg"],
    intents: ["zorgtoeslag berekenen", "mogelijk in aanmerking voor zorgtoeslag", "zorgtoeslag 2026"],
    related: ["toeslagen", "huurtoeslag", "kindgebonden-budget", "toeslagen-2026"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Zorgtoeslag berekenen 2026 | Indicatie zorgtoeslag | Calculatieloket.nl",
      description: "Bereken je zorgtoeslag in 2026. Zie of je mogelijk recht hebt op zorgtoeslag. Een indicatie op basis van inkomen en vermogen.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — Zorgtoeslag",
        description: "Voorwaarden en bedragen voor zorgtoeslag.",
        href: "https://www.belastingdienst.nl/toeslagen/zorgtoeslag",
      },
    ],
  },
  {
    ...
    url: "/kindgebonden-budget-berekenen/",
    title: "Kindgebonden budget berekenen",
    shortTitle: "Kindgebonden budget",
    description: "Bereken of je mogelijk recht hebt op kindgebonden budget in 2026. Een indicatie op basis van inkomen en kinderen.",
    shortDescription: "Bereken je kindgebonden budget.",
    category: "Toeslagen",
    iconKey: "users",
    keywords: ["kindgebonden budget", "kinderbudget", "toeslag kinderen", "kgb"],
    intents: ["kindgebonden budget berekenen", "toeslag kinderen", "kindgebonden budget 2026"],
    related: ["toeslagen", "huurtoeslag", "zorgtoeslag", "toeslagen-2026"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Kindgebonden budget berekenen 2026 | Indicatie | Calculatieloket.nl",
      description: "Bereken of je mogelijk recht hebt op kindgebonden budget in 2026. Een indicatie op basis van inkomen en kinderen.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — Kindgebonden budget",
        description: "Voorwaarden en bedragen voor kindgebonden budget.",
        href: "https://www.belastingdienst.nl/toeslagen/kindgebonden-budget",
      },
    ],
  },
  {
    ...
    slug: "toeslagen-2026",
    url: "/toeslagen-2026/",
    title: "Toeslagen 2026",
    shortTitle: "Toeslagen 2026",
    description: "Overzicht van toeslagen in 2026: huurtoeslag, zorgtoeslag, kindgebonden budget. Bereken een indicatie.",
    shortDescription: "Overzicht toeslagen in 2026.",
    category: "Toeslagen",
    iconKey: "money",
    keywords: ["toeslagen 2026", "toeslagen overzicht", "huurtoeslag", "zorgtoeslag", "kindgebonden budget"],
    intents: ["toeslagen 2026", "overzicht toeslagen", "alle toeslagen"],
    related: ["toeslagen", "huurtoeslag", "zorgtoeslag", "kindgebonden-budget"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Toeslagen 2026 | Alle toeslagen op een rij | Calculatieloket.nl",
      description: "Overzicht van toeslagen in 2026: huurtoeslag, zorgtoeslag, kindgebonden budget. Bereken een indicatie en bekijk de voorwaarden.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "Belastingdienst — Toeslagen",
        description: "Overzicht en voorwaarden van alle toeslagen.",
        href: "https://www.belastingdienst.nl/toeslagen",
      },
    ],
  },
  {
    id: "maximale-hypotheek",
    slug: "maximale-hypotheek-berekenen",
    url: "/maximale-hypotheek-berekenen/",
    title: "Maximale hypotheek berekenen",
    shortTitle: "Maximale hypotheek",
    description: "Bereken je maximale hypotheek in 2026. Een indicatie op basis van je inkomen.",
    shortDescription: "Bereken je maximale hypotheek.",
    category: "Wonen",
    iconKey: "house",
    keywords: ["maximale hypotheek", "hoeveel hypotheek", "hypotheek berekenen", "lenen woning"],
    intents: ["maximale hypotheek berekenen", "hoeveel kan ik lenen", "hypotheek indicatie"],
    related: ["hypotheek", "hypotheek-maandlasten", "hypotheek-rente", "hypotheek-2026"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Maximale hypotheek berekenen 2026 | Indicatie | Calculatieloket.nl",
      description: "Bereken je maximale hypotheek in 2026. Een indicatie op basis van je inkomen. Voor een definitief advies raadpleeg je een hypotheekadviseur.",
    },
    officialSources: [
      {
        label: "Officiële bron",
        title: "AFM — Hypotheekregels",
        description: "Informatie over verantwoord lenen.",
        href: "https://www.afm.nl/consumenten/hypotheek",
      },
    ],
  },
  {
    id: "hypotheek-maandlasten",
    slug: "hypotheek-maandlasten-berekenen",
    url: "/hypotheek-maandlasten-berekenen/",
    title: "Hypotheek maandlasten berekenen",
    shortTitle: "Hypotheek maandlasten",
    description: "Bereken je hypotheek maandlasten in 2026. Een indicatie van aflossing en rente.",
    shortDescription: "Bereken je hypotheek maandlasten.",
    category: "Wonen",
    iconKey: "house",
    keywords: ["hypotheek maandlasten", "maandlasten hypotheek", "hypotheek lasten", "maandlasten woning"],
    intents: ["hypotheek maandlasten berekenen", "maandlasten hypotheek", "hoeveel betaal ik per maand hypotheek"],
    related: ["hypotheek", "maximale-hypotheek", "hypotheek-rente", "hypotheek-2026"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Hypotheek maandlasten berekenen 2026 | Indicatie | Calculatieloket.nl",
      description: "Bereken je hypotheek maandlasten in 2026. Een indicatie van aflossing en rente. Voor advies raadpleeg je een hypotheekadviseur.",
    },
    officialSources: [
      {
        label: "Officiële bron",
  ...
  {
    id: "hypotheek-rente",
    slug: "hypotheek-rente-berekenen",
    url: "/hypotheek-rente-berekenen/",
    title: "Hypotheek rente berekenen",
    shortTitle: "Hypotheek rente",
    description: "Bereken de rente op je hypotheek in 2026. Een indicatie van maandlasten en totale rente.",
    shortDescription: "Bereken de rente op je hypotheek.",
    category: "Wonen",
    iconKey: "percent",
    keywords: ["hypotheek rente", "rente hypotheek", "hypotheekrente", "rente berekenen"],
    intents: ["hypotheek rente berekenen", "hoeveel rente betaal ik", "hypotheekrente 2026"],
    related: ["hypotheek", "maximale-hypotheek", "hypotheek-maandlasten", "hypotheek-2026"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Hypotheek rente berekenen 2026 | Rente op hypotheek | Calculatieloket.nl",
      description: "Bereken de rente op je hypotheek in 2026. Een indicatie van maandlasten en totale rente. Voor advies raadpleeg je een hypotheekadviseur.",
    },
    officialSources: [
      {
        label: "Officiële bron",
  ...
  },
  {
    ...
    slug: "hypotheek-2026",
    url: "/hypotheek-2026/",
    title: "Hypotheek 2026",
    shortTitle: "Hypotheek 2026",
    description: "Alles over hypotheek in 2026: regels, rente, maximale hypotheek en maandlasten.",
    shortDescription: "Overzicht hypotheek in 2026.",
    category: "Wonen",
    iconKey: "house",
    keywords: ["hypotheek 2026", "hypotheek regels 2026", "hypotheek rente 2026", "woninglening 2026"],
    intents: ["hypotheek 2026", "regels hypotheek 2026", "hypotheek rente 2026"],
    related: ["hypotheek", "maximale-hypotheek", "hypotheek-maandlasten", "hypotheek-rente"],
    difficulty: "beginner",
    country: "NL",
    language: "nl",
    status: "active",
    ...
    lastUpdated: "2026-07-27",
    seo: {
      title: "Hypotheek 2026 | Berekenen, rente en regels | Calculatieloket.nl",
      description: "Alles over hypotheek in 2026: regels, rente, maximale hypotheek en maandlasten. Een indicatie. Voor advies raadpleeg je een hypotheekadviseur.",
    },
    officialSources: [
      {
        label: "Officiële bron",
