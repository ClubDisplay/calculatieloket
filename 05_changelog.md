...
**Type:** Docs / Audit
**Wijziging:** PR #64 — Salary and bruto-netto cluster audit
...
**Type:** Docs / Agents
**Wijziging:** PR #63 — SEO Growth Agents
...
**Wijziging:** PR #62 — SEO & AdSense Growth Dashboard
...
**Status:** ✅ Gemerged en gedeployed naar productie
**Details:** Verwijderd alle zichtbare under-construction placeholders ("Kennisbank (binnenkort)", "Calculator Explorer (binnenkort)", "Toeslagen (binnenkort)", "Nieuws (binnenkort)") uit de header- en footer-navigatie in `src/layouts/BaseLayout.astro`, inclusief de overbodige placeholder-CSS. `scripts/audit-content-safety.mjs` uitgebreid met automatische detectie van "binnenkort", "in aanbouw", "work in progress", "tijdelijk niet beschikbaar" en placeholder-klassen in zowel gerenderde HTML als paginabron. Nieuw document `docs/adsense-readiness-checklist.md` met de complete checklist voor AdSense-approval (ads.txt, geen placeholders, geen lege advertentiecontainers, content-kwaliteit, privacy/consent, technische output en handmatige AdSense-verificatie). Geen wijzigingen aan calculator engines, Knowledge Objects, Rule Resolver, Recommendation Engine, SEO-copy, sitemap, robots of rekenlogica. `public/ads.txt` was reeds aanwezig en correct; na build ook in `dist/ads.txt` en bereikbaar op productie. Productie-build is uitgevoerd met `PUBLIC_ADS_ENABLED=true`.
**Build:** 23 pagina's, 0 TypeScript-fouten.
**Tests:** 253/253 geslaagd.
...
**Type:** Docs / Strategy
**Wijziging:** PR #61 — Internationale domeinstrategie
...
**Wijziging:** PR #55 — Content-safety fix (harde claims + placeholders)
...
**Type:** UX / Closed
**Wijziging:** PR #54 — Overbodige calculator buttons (gesloten)
